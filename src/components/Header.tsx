...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'header-blur' : 'bg-transparent'} w-full`}>
      <div className="w-full px-6 lg:px-8 bg-white">
        <div className="flex justify-between items-center py-6">
          ...
          <nav className="hidden lg:flex items-center space-x-2 flex-1 justify-end">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}

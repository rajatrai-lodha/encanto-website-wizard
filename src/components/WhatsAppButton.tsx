    ...
    <div className="fixed bottom-6 right-6 z-50">
      <Button
        ...
        className={`
          ...
          ${isHovered ? 'scale-110 animate-pulse-glow' : 'animate-bounce'}
        `}
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 rounded-full border border-green-300 animate-ping opacity-50" style={{ animationDelay: '0.5s' }}></div>
      </Button>
